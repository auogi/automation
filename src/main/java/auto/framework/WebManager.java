...
import auto.framework.drivers.HeadlessDriver;
...
public class WebManager {
    ...
    public static BrowserStackDriver getBrowserStackRemoteDriver() {
    	WebDriver driver = WebManager.getDriver();
    
    	return (BrowserStackDriver) driver;
    }
    
    public static BrowserStackDriver getBrowserStackDriver() {
    	WebDriver driver = WebManager.getDriver();
    	...
    	try {    
    			...
    			switch(browserInfo.browserType.trim().toLowerCase()){
		    		...
		    		case "firefox":
		    			...
		    			break;		    			
		    		case "headless":
		    			driver = HeadlessDriver.start();
		    			return setDriver(driver);		    			
		    		case "browserstack":
		    			driver = BrowserStackDriver.start(runLocal);
