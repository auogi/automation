...
import auto.framework.TestManager.Preferences;
import auto.framework.drivers.BrowserStackDriver;
...
import auto.framework.telegram.TelBot;
...
/*			Console.log("[Test Suite] %s\n", name);*/
		...
		public TestCase addTestCase(String name){
			...
			if(BrowserStackDriver.sessionID!=null && !Boolean.valueOf(TestManager.Preferences.getPreference("turnOffSelenium"))){			
				try{
					currentCase.addPlayback("BrowserStack Playback", BrowserStackDriver.getBrowserStackInfos().automation_session.public_url);
					//currentCase.addPlayback("AppliTools Report", "https://eyes.applitools.com/app/test-results/00000251878353204087?accountId=mBBxZ-e1JESAEBmikvX03g~~");
